...
public class HotOrNot {
    ...
    public long createEntry(String name, String hotness) {
        //Sql injection dann kacinmak icin content values ile ekledi sorgu ile de ekleyebilrdi normalde.
    ...
    public String getName(long l) throws SQLException{
        ...
        if(c != null){
            c.moveToFirst();
            // 1= 1. column demek index 0 1 2 diye gider.
